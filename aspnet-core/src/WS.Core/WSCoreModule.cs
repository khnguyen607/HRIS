...
namespace WS
{
    ...
    public class WSCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, WSMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
