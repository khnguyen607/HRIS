...
@NgModule({
    providers: [
        ApiServiceProxies.TechnicalReqsesServiceProxy,        
        ApiServiceProxies.BasicReqsesServiceProxy,        
        ApiServiceProxies.RecruitmentsServiceProxy,        
        ApiServiceProxies.RecruitmentCandidatesServiceProxy,        
